...
%
%   [ GEO ] = GEOM2GEO( SIN, HMAX, HMAXB, HMAXP, FILE_NAME, FID_LOG, TOL, USE_COMPOUND )
%   Generate GEO data for use with the grid generator Gmsh.
%
...
%
%   The USE_COMPOUND flag indicates if Gmsh compound lines and
%   surfaces should be used (default true).
%
%   BIX output GEO struct field contains boundary numbers matching to
%   physical followed by additional compound line entries in 2D and
