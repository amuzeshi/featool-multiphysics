...
fea.phys.ns.bdr.coef{2,end}{1,9} = 'u2';   % Brinkman velocity from shared boundary.
fea.phys.ns.bdr.coef{2,end}{2,9} = 'v2';
...
fea.phys.br.bdr.coef{2,end}{1,9} = 'u';   % NS velocity from shared boundary.
fea.phys.br.bdr.coef{2,end}{2,9} = 'v';
