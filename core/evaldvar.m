...
%
%   [ VDVARVAL ] = EVALDVAR( SFUN, I_EVAL, N_SDIM, N_VERT, I_DOF, XI, AINVJAC, C, U )
%   Evaluates a dependent variable in point XI on the cells given in C.
...
%       c           [n_ldof,n_cells]       Dof connectivity map (for each cell)
